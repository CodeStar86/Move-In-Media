...
import silverTemplateImage from '@/assets/silver-template.png';
import goldTemplateImage from '@/assets/gold-template.png';
...
export function Homepage() {
  ...
  return (
    <PublicLayout>
      <SEO title="Home" description="Professional websites for estate agents. Fixed pricing, fast delivery, no hidden costs. Showcase your properties beautifully." canonicalPath="/" />
      {/* Hero Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <p className="mt-4 sm:mt-6 text-lg sm:text-xl text-white drop-shadow-md">
                Showcase your properties with stunning, professionally designed websites. Fixed pricing, fast delivery, no hidden costs.
              </p>
