...
export function PackagesPage() {
  ...
  return (
    <PublicLayout>
      <SEO title="Packages" description="Explore website packages for estate agents — clear pricing, powerful features, and fast launch times." canonicalPath="/packages" />
      <div className="py-20">
